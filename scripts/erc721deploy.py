...
async def main(deploy_env):
    ...
    contract_name = "ERC721copy"
    deployer = DeployContract(
        contract_name=contract_name, 
        deployer_config=deployer_config,
        constructor_args={
            "initial_supply": 10000, 
            "recipient": int(deployer_config.account_address, 16),  
            "name": "deadalus",
            "symbol": "felt252",
            "recipient": int("0x045f03850a3e47a896e9da998011ec42f2f282b02d8b0914f9e7f1ba17ab0266", 16), # must cast address string to int16
            "token_amount": 2,    
        }
    )
