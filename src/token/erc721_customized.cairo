...
#[starknet::contract]
mod ERC721Customized {
    use openzeppelin::introspection::src5::SRC5Component;
    use openzeppelin::token::erc721::ERC721Component;
    use deadalus::custom::custom::CustomComponent;
    ...
    // SRC5
    #[abi(embed_v0)]
    impl CustomImpl = CustomComponent::CustomImpl<ContractState>;
    impl CustomInternalImpl = CustomComponent::InternalImpl<ContractState>;
    ...
    #[constructor]
    fn constructor(
        ref self: ContractState, name: felt252, symbol: felt252, // recipient: ContractAddress,
    // token_amount: u256,
    // token_uri: felt252
    ) {
    ...
    #[external(v0)]
    fn mint(ref self: ContractState, token_id: u256, token_trait: TokenTrait) {
        let caller = starknet::get_caller_address();

        self.custom.add_token_trait(:token_id, :token_trait);
        self.erc721._mint(to: caller, :token_id);
    }
    #[generate_trait]
    impl InternalImpl of InternalTrait {
        ...
        // token_uri: felt252
            ...
            let mut id = 1;
            // 'https://ipfs.io/ipfs/QmSgasATmDAqHYz8d5nqrzrJLDoZpDs71JDDmwzmdKwZ1k'
            // let token_uri: Span<felt252> = array![
            //     'https://ipfs.io/ipfs/QmSgas', 'ATmDAqHYz8d5nqrzrJL', 'DoZpDs71JD', 'DmwzmdKwZ1k'
            // ]
            //     .span();
